...
export function Pricing() {
  ...
  return (
    <section id="pricing" className="px-4 py-20 sm:py-28 sm:px-6 lg:px-8 bg-background relative">
      <div className="mx-auto max-w-7xl">
        <div className="text-center mb-16 animate-in fade-in slide-in-from-bottom-3 duration-700">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto text-pretty">
            Osnovne cene za iznajmljivanje - vi preuzimate i vraćate mašinu. Bez skrivenih troškova!
          </p>
        </div>
          ...
          {pricingPlans.map((plan, index) => (
            ...
            >
              ...
              <CardHeader className="text-center pb-4 pt-8">
                <CardTitle className="text-2xl font-bold text-foreground mb-3">{plan.duration}</CardTitle>
                <div className="mb-3">
                  <span className="text-5xl font-bold text-primary">{plan.price}</span>
                  <span className="text-muted-foreground ml-2 text-lg">RSD</span>
                </div>
              ...
              <CardContent className="pt-0 pb-8">
                <ul className="space-y-4 mb-8">
                  <li className="flex items-start gap-3">
                    ...
                    <span className="text-sm text-muted-foreground">Profesionalna mašina za pranje</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="flex h-6 w-6 items-center justify-center rounded-full bg-primary/10 flex-shrink-0 mt-0.5">
                      <Check className="h-4 w-4 text-primary" />
                    </div>
                    <span className="text-sm text-muted-foreground">Osnovna uputstva za upotrebu</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="flex h-6 w-6 items-center justify-center rounded-full bg-primary/10 flex-shrink-0 mt-0.5">
                      <Check className="h-4 w-4 text-primary" />
                    </div>
                    <span className="text-sm text-muted-foreground">Vi preuzimate i vraćate</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="flex h-6 w-6 items-center justify-center rounded-full bg-primary/10 flex-shrink-0 mt-0.5">
                      <Check className="h-4 w-4 text-primary" />
                    </div>
                    <span className="text-sm text-muted-foreground">Telefonska podrška 24/7</span>
                  </li>
                </ul>
                <Button
        ...
        <div className="max-w-4xl mx-auto">
          <h3 className="text-2xl font-bold text-center mb-10 text-foreground">Dodatne usluge</h3>
                ...
                <CardContent className="pt-8 pb-6">
                  <div className="flex items-start gap-5">
                    ...
                    <div className="flex-1">
                      <h4 className="font-semibold text-lg text-foreground mb-3">{service.title}</h4>
                      <div className="space-y-2">
                        {service.prices.map((priceItem, priceIndex) => (
                          ...
                          >
                            <span className="text-sm text-muted-foreground">{priceItem.city}</span>
                            <span className="text-sm font-semibold text-primary">{priceItem.price}</span>
                          </div>
                        ))}
                      </div>
                    </div>
        ...
        <div className="mt-12 text-center px-4">
          <p className="text-sm text-muted-foreground max-w-2xl mx-auto leading-relaxed bg-secondary/50 rounded-xl px-6 py-4">
            <strong className="text-foreground">Napomena:</strong> Osnovne cene podrazumevaju da vi preuzimate i vraćate
            mašinu sa naše lokacije. Za dostavu na vašu adresu i dodatnu obuku na licu mesta, pogledajte dodatne usluge.
          </p>
        </div>
      </div>
    </section>
