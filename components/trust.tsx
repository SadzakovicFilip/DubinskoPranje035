export function TrustBlock() {
  return (
    <section id="poverenje" className="scroll-mt-16 px-4 py-16 sm:py-20 sm:px-6 lg:px-8 bg-secondary/40">
          ...
          <div className="rounded-2xl bg-primary text-primary-foreground p-8 space-y-4 shadow-xl shadow-primary/20">
            <div className="space-y-3">
              ...
              <div className="flex items-center gap-3">
                ...
                <span className="text-sm font-medium">Preuzimanje 10h-20h, dostava 16h-19h</span>
              </div>
            </div>
          </div>
        </div>
